object LearningScala1 {
  ...
  val myPi: Double = 3.142857                     //> myPi  : Double = 3.142857
  val newPi: Double = myPi*2                      //> newPi  : Double = 6.285714
  println(f"The value of double th pi is $newPi%.3f")
                                                  //> The value of double th pi is 6.286
  println(f"Pi is about $piSinglePrecision%.3f")  //> Pi is about 3.142
