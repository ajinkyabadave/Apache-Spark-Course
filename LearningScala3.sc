object LearningScala3 {
  ...
  def upper(myString: String) : String = {
    myString.toUpperCase
  
  }                                               //> upper: (myString: String)String
  
  println(upper("Ajinkya"))                       //> AJINKYA
  
  def transformString(x: String, f: String => String) : String = {
   f(x)
  }                                               //> transformString: (x: String, f: String => String)String
  
  transformString("ajinkya",upper)                //> res3: String = AJINKYA
  transformString("ajinkya",x=>x.toUpperCase)     //> res4: String = AJINKYA
